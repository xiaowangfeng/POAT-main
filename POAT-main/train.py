...
def validate(val_loader, model, criterion, normalizer, test=False, return_pred=False, cuda=True, return_target=False, return_id=False, csv_name='test_results.csv'):
    batch_time = AverageMeter()
    losses = AverageMeter()
    mae_errors = AverageMeter()
